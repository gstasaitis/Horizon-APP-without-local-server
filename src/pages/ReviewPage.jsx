...
const ReviewPage = () => {
  ...
  const fetchCarAndReviews = async () => {
    try {
      const carResponse = await fetch(`https://horizon-api.glitch.me/cars/${id}`);
      const carData = await carResponse.json();
      setCar(carData);

      const reviewsResponse = await fetch(
        `https://horizon-api.glitch.me/reviews?productId=${carData.id}`
      );
  ...
  const handleAddReview = async (newReview) => {
    try {
      const response = await fetch("https://horizon-api.glitch.me/reviews", {
        method: "POST",
        headers: {
  ...
  const handleEditReview = async (editedReview) => {
    try {
      const response = await fetch(`https://horizon-api.glitch.me/reviews/${editingReviewId}`, {
        method: "PUT",
        headers: {
          "Content-Type": "application/json",
        },
  ...
  const handleDeleteReview = async (reviewId) => {
    try {
      const response = await fetch(`https://horizon-api.glitch.me/reviews/${reviewId}`, {
        method: "DELETE",
      });
      if (!response.ok) {
